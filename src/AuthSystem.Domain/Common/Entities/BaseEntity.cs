// File: AuthSystem.Domain/Common/Entities/BaseEntity.cs
using System;
...
namespace AuthSystem.Domain.Common.Entities
{
        ...
        where TId : notnull
    {
        ...
        /// <summary>شناسه یکتای موجودیت</summary>
        public TId Id { get; protected set; } = default!;

        /// <summary>تاریخ ایجاد موجودیت (UTC)</summary>
        ...
        /// <summary>آیا موجودیت هنوز موقتی است (در پایگاه داده ذخیره نشده)</summary>
        ...
        /// </summary>
        protected virtual void MarkAsUpdated() => UpdatedAt = DomainClock.UtcNow;
